...
author: "Guilherme Fernandes - 3398,  Júlia Letícia - 3732, Victor Hugo - "
date: '05/07/2022'
output:
  html_document:
    toc: true
...
### Proporção da Praga em relação ao Fertilizante
...
Foi feito um Teste Qui-Quadrado para avaliar a proporção de Praga em cada um dos Fertilizantes.
A diferença não foi significativa, ou seja, as proporções são iguais estatisticamentes a um nível de significância de 5%.
...
Concluímos que o melhor fertilizante é o B, pois tem a maior produção e possui a mesma incidência de pragas do que os demais fertilizantes.